...
import { Flex, Input, Checkbox, FlexProps, Select, Tooltip, IconButton, useToast } from "@chakra-ui/react";
    ...
    <div>
      ...
      >
        ...
        {itemState.type?.value === "object" ? (
          ...
          <Tooltip hasArrow aria-label="Add Sibling Node" label="Add Sibling Node" placement="top">
            <IconButton
              isRound
              isDisabled={isReadOnlyState.value}
              size="sm"
